...
```bash
# 通用
export WEIBO_USER_IDS=1087770692,1749127163
export WEIBO_TWEET_IDS=Mb15BDYR0,LqlZNhJFm
export WEIBO_KEYWORDS=丽江,杭州

# 时间控制（tweet_by_user_id / tweet_by_keyword）
export WEIBO_CRAWL_TIME_SPAN=false
export WEIBO_START_TIME="2024-01-01 00:00:00"
export WEIBO_END_TIME="2024-12-31 23:59:59"
export WEIBO_SPLIT_BY_HOUR=true
```

Windows PowerShell 写法：

```powershell
$env:WEIBO_USER_IDS="1087770692,1749127163"
$env:WEIBO_TWEET_IDS="Mb15BDYR0,LqlZNhJFm"
$env:WEIBO_KEYWORDS="丽江,杭州"
$env:WEIBO_CRAWL_TIME_SPAN="false"
$env:WEIBO_START_TIME="2024-01-01 00:00:00"
$env:WEIBO_END_TIME="2024-12-31 23:59:59"
$env:WEIBO_SPLIT_BY_HOUR="true"
```
